...
const projects = [
  ...
  id: 14,
  title: "AI 英语语音段位闯关工具",
  desc: "适合小学英语、初中英语发音练习和口语训练使用。学生可以从音标、已学单词、新单词、近似音单词、朗读长句到绕口令逐级闯关，每一关都可以先听标准朗读，再进行录音挑战。系统会自动进行 AI 语音评分，反馈准确度、流利度、完整度和韵律感，帮助学生像闯关一样练习英语发音，提升开口积极性",
  shareStatus: "public",
  categories: ["英语发音", "AI语音评分", "口语练习", "课堂工具"],
  target: "英语老师、小学英语课堂、初中英语课堂、需要英语发音和口语练习的学生",
  subject: "英语",
  environment: "手机 / 电脑浏览器",
  port: "无需端口",
  links: {
    demo: "https://www.douyin.com/video/7652618852752726902",
    download: "https://yingbiao.teacherlin.store/"
  }
},
  {
  id: 15,
  ...
  {
  id: 16,
  title: "浙江高考志愿 AI 辅助系统",
  desc: "适合浙江高考普通类考生和家长做志愿初筛参考使用。学生可以输入高考分数、位次、选科、意向地区、学校类型、收费接受度、宿舍生活偏好和未来职业期待，系统会生成志愿分析报告，并整理冲一冲、稳一稳、保一保的院校专业建议，同时提示位次差距、选科匹配、民办收费等风险点。工具仅用于志愿初筛和思路参考，最终填报请以官方志愿填报系统和高校招生章程为准",
  shareStatus: "public",
  categories: ["高考志愿", "AI工具", "升学规划", "志愿填报"],
  target: "浙江高考考生、家长、高中班主任、需要进行志愿初筛和升学规划参考的用户",
  subject: "高考志愿 / 升学规划",
  environment: "手机 / 电脑浏览器",
  port: "3030",
  links: {
